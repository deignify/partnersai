...
import { MessageCircleHeart, Mail, Lock, Eye, EyeOff, Loader2, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center space-y-3">
          {mode === 'forgot' && (
            <button onClick={() => { setMode('signin'); setForgotSent(false); }} className="flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground transition-colors mb-2">
